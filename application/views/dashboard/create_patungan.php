...
<nav class="navbar navbar-dark navbar-custom">
    <div class="container-fluid">
        <h1 class="navbar-brand mb-0">Buat Patungan Baru</h1>
        ...
        <div class="card-body">
            ...
            <form method="post" action="<?php echo base_url('index.php?/patungan_ctrl/create'); ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama_grup" name="nama_grup" placeholder="Contoh: Makan Bersama" required>
                </div>

                <div class="mb-3">
                    <label for="total_biaya" class="form-label">Total Biaya (Rp)</label>
                    <input type="number" class="form-control" id="total_biaya" name="total_biaya" placeholder="0" min="1" step="0.01" required>
                </div>

                <div class="mb-3">
                    <label for="anggota" class="form-label">Daftar Anggota (satu nama per baris)</label>
                    <textarea class="form-control" id="anggota" name="anggota" rows="6" placeholder="Nama anggota 1&#10;Nama anggota 2&#10;Nama anggota 3" required></textarea>
                </div>
